...
test("small widget previews one non-interactive next queue item", () => {
  ...
  assert.match(smallItem, /frame=\{\{ maxWidth: "infinity", height: 57, alignment: "leading" \}\}/)
  ...
  assert.match(smallItem, /frame=\{\{ maxWidth: "infinity", height: 14, alignment: "leading" \}\}/)
  assert.match(smallItem, /padding=\{\{ top: -5, bottom: 5, leading: 5, trailing: 5 \}\}/)
  ...
  assert.match(smallItem, /padding=\{\{ top: -5, leading: 5, trailing: 5, bottom: 9 \}\}/)
  assert.match(source, /function SmallNextItemPreview/)
  const preview = source.slice(
    source.indexOf("function SmallNextItemPreview"),
    source.indexOf("function ListWidget"),
  )
  assert.match(preview, /padding=\{\{ top: 4, leading: 5, trailing: 5 \}\}/)
