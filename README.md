...
紧凑原生风格的 iPhone 到期事项组件，按 Apple 公布的 WidgetKit 尺寸自适应小、中、大版式，支持信用卡账单、订阅、周期事项与 Apple 提醒事项。点击完成后，系统蓝色圆圈切换为对勾，当前事项与下一件交叉淡化补位。事项名称会在本机智能匹配 SF Symbols，也可手动选择图标。
