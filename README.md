...
紧凑原生风格的 iPhone 到期事项组件，按 Apple 公布的 WidgetKit 尺寸自适应小、中、大版式，支持信用卡账单、订阅、周期事项与 Apple 提醒事项，并可通过提醒事项风格的完成动画直接处理本期。事项名称会在本机智能匹配 SF Symbols，也可手动选择图标。
...
- `tests/`：日期、周期、图标匹配、完成动画快照、队列补位、幂等完成和提醒事项完成测试。
