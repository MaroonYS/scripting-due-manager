...
紧凑原生风格的 iPhone 到期事项组件，按 Apple 公布的 WidgetKit 尺寸自适应小、中、大版式，支持信用卡账单、订阅、周期事项与 Apple 提醒事项。小号组件会在当前事项下方预告队列中的下一项；完成控件使用 WidgetKit 的交互式 Toggle，事项保存后当前项与下一项按时间线过渡补位，并可立即继续完成新出现的事项。事项名称会在本机智能匹配 SF Symbols，也可手动选择图标。
