...
小号组件可选的 SafePal、Telegram 品牌图案属于各自权利人，保持官方素材原字节，
仅作用户事项的描述性识别，不是到期管家的品牌或官方合作标识。素材单独适用其
官方使用指南，不受本项目的独占版权主张约束；来源、哈希及显示限制见安装包内
`assets/brands/SOURCES.md`。品牌名称目录不等于已取得所有品牌图案许可。
